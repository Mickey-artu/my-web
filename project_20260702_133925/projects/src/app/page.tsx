...
import { FlowerIcon, BookIcon, HeartIcon, FireIcon } from '@/components/icons';
import { Progress } from '@/components/ui/progress';

type TabType = 'home' | 'learn' | 'review' | 'stats' | 'rewards';
      ...
      <div className="min-h-screen bg-[#FFFDF9] pb-24">
        ...
        <div className="max-w-lg mx-auto px-6 mt-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <button
              onClick={() => setActiveTab('rewards')}
              className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-4 text-left hover:shadow-sm transition-shadow border border-amber-100"
            >
              <div className="flex items-center gap-2 mb-2">
                <span className="text-lg">📦</span>
                <span className="font-medium text-[#B8860B]">盲盒</span>
              </div>
